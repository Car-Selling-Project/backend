...
import { countCustomers, getOrdersWithRevenue, getSoldCars, getTopSalesAdmins } from "../controllers/Dashboard.controller.js";
...
DashboardStatRouter.get("/dashboard-stat/active-customers" , authAdmin , countCustomers);
