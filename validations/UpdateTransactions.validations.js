...
export const transactionUpdateValidationSchema = Joi.object({
  order: Joi.string()
    .optional()
  ...
  paymentMethod: Joi.string().valid("cash", "bank_transfer", "loan").optional(),
  type: Joi.string().valid("deposit", "full_payment").optional(),
